"""
grammar_rules.py
Todas as regras gramaticais PLY para Fortran 77.
Importado por fortran77_parser.py que constrói o parser final.
"""

import sys, os
sys.path.insert(0, os.path.dirname(os.path.dirname(__file__)))

from lexer.tokens import tokens  # noqa: F401  (ply.yacc precisa de tokens aqui)
from parser.ast_nodes import *

# ============================================================
# PRECEDÊNCIAS
# O PLY exige que "precedence" esteja no mesmo módulo que as regras p_*.
# ============================================================
